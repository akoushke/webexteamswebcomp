...
export default class WebexTeamsAlert extends HTMLElement {
  constructor() {
    super();
 ...
 convert(propTypes, attrName, attrValue) {
  ...
  mount() {
    const props = {
      ...this.getProps(this.attributes, Alert.propTypes)
    };
...
window.customElements.define('wbx-tms-alert', WebexTeamsAlert);